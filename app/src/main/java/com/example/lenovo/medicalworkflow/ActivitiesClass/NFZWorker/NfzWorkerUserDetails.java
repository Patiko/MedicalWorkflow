...
public class NfzWorkerUserDetails extends Activity {
...
/*    TextView npwz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nfz_worker_user_details);
        ...
        workTitle = (TextView) findViewById(R.id.workDataTV);
        workTitle.setTypeface(null, Typeface.BOLD);
    ...
    public void runUpdateUser(View view) {
        ...
        if(post_code.getText().toString().trim().length() != 5) {
            ...
            if(mydb.updateUser(id_To_Update,first_name.getText().toString(),last_name.getText().toString(),pesel.getText().toString(),login.getText().toString(),
                    ...
                    "","",work_name.getText().toString(),"","",mydb.getPayerPlace(post_code.getText().toString()))){
                Toast.makeText(getApplicationContext(), "Użytkownik został zmieniony", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(getApplicationContext(),NfzWorkerMainScreen.class);
