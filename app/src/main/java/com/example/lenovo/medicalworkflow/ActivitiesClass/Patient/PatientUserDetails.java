...
public class PatientUserDetails extends Activity {
...
/*                    b1 = (Button) findViewById(R.id.button1);
    ...
    public void runUpdateUser(View view) {
        ...
        if (!first_name.getText().toString().equals("") && !last_name.getText().toString().equals("") && !pesel.getText().toString().equals("") && pesel.getText().toString().trim()
                .length() == 11 && !login.getText().toString().equals("") && !password.getText().toString().equals("") && !post_code.getText().toString().equals("")
                && post_code.getText().toString().trim().length() == 6 && !birthdate.getText().toString().equals("") && birthdate.getText().toString().trim().length()==10 ) {
            if(mydb.updateUser(id_To_Update,first_name.getText().toString(),last_name.getText().toString(),pesel.getText().toString(),login.getText().toString(),
                    ...
                    "","","","","",mydb.getPayerPlace(post_code.getText().toString()))){
        ...
        }else if(birthdate.getText().toString().trim().length()!=10) {
            Toast.makeText(getApplicationContext(), "Proszę podać date urodzenia np.03.12.2017 (DD.MM.YYYY)",
                    Toast.LENGTH_LONG).show();
        } else if(post_code.getText().toString().trim().length() != 6) {
            Toast.makeText(getApplicationContext(), "Proszę podać kod pocztowy np. 05-950",
                    Toast.LENGTH_LONG).show();
        }
