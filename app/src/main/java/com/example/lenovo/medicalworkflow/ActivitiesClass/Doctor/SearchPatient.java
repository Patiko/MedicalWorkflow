...
import com.example.lenovo.medicalworkflow.CustomAdapterPatients;
...
public class SearchPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapterPatients = new CustomAdapterPatients(SearchPatient.this, cursor, 0);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
                ...
                if(id_To_Search!=0){
                    ...
                    Intent intent = new Intent(getApplicationContext(), UsedPatientDetails.class);
            ...
            search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextSubmit(String pesel) {
                  //  Log.d(TAG, "onQueryTextSubmit ");
                    ...
                    if (cursor==null){
                        Toast.makeText(SearchPatient.this,"Nie znaleziono!",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(SearchPatient.this, "Znaleziono "+cursor.getCount() + " rekordy!",Toast.LENGTH_LONG).show();
                    }
